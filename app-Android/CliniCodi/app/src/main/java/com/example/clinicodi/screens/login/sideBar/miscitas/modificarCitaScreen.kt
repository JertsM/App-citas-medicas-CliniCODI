...
import com.example.clinicodi.screens.login.sideBar.convertirFecha
                        ...
                        Button(
                            onClick = {
                                val citaRequest = CitaRequest(
                                    ...
                                    fecha = convertirFecha(diaSeleccionado),
                                    hora = horaSeleccionada!!
                                )

                                coroutineScope.launch {
                                    try {
                                        val response = api.modificarCita(
                                            idCita,
                                            citaRequest
                                        )
                                        ...
                                        if (response.isSuccessful) {
                                            ...
                                            Toast.makeText(
                                                context,
                                                "Esa fecha y hora no están disponibles",
                                                Toast.LENGTH_SHORT
                                            ).show()
                                        }
                                    } catch (e: Exception) {
